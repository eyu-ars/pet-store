...
public class PetStoreService {
  ...
  /**
   * A method that accepts pet store id and returns pet store object associated with 
   * a give Id if pet store Id is not null, otherwise creating new pet store object.
